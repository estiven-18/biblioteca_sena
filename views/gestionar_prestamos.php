        ...
        <div class="sidebar">
            <div>
                ...
                <nav class="nav flex-column">
                    ...
                    <a href="gestionar_libros.php" class="nav-link"><i
                            class="bi bi-journal-bookmark me-2"></i>Libros</a>
                    <a href="gestionar_reservas.php" class="nav-link"><i
                            class="bi bi-calendar-check me-2"></i>Reservas</a>
                    <a href="gestionar_prestamos.php" class="nav-link active"><i
                            class="bi bi-box-seam me-2"></i>Préstamos</a>
                    ...
                    <a href="historial_prestamos.php" class="nav-link "><i
                            class="bi bi-clock-history me-2"></i>Historial Prestamos</a>
                    <a href="historial_reservas.php" class="nav-link "><i
                            class="bi bi-calendar-range me-2"></i>Historial Reservas</a>
                    ...
                    <tbody>
                        ...
                        while ($prestamo = mysqli_fetch_assoc($resultado)):
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-success btn-sm btnDevolver"
